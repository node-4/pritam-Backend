...
exports.editEvent = async (req, res) => {
    try {
        ...
        const findData = await eventModel.findOne({ _id: { $ne: event._id }, title: req.body.title });
        if (findData) {
            return res.status(409).json({ status: 409, message: "Already exit ", data: {} })
        } else {
            const data = {
    ...
    try {
        ...
        if (findData) {
            ...
            const data = {
                ...
                contactUsformTitle: req.body.contactUsformTitle || findData.contactUsformTitle,
                contactUsformDesc: req.body.contactUsformDesc || findData.contactUsformDesc,
                contactUsformAvaili: req.body.contactUsformAvaili || findData.contactUsformAvaili,
            ...
            const data = {
                ...
                contactUsformTitle: req.body.contactUsformTitle,
                contactUsformDesc: req.body.contactUsformDesc,
                contactUsformAvaili: req.body.contactUsformAvaili,
